...
public interface ConnectionRepository extends JpaRepository<Connection, Long> {
	...
	@Query(value = "select * from connection where connectionStatus='ACTIVE' and village=?1",nativeQuery = true)
	...
	@Query(value = "select * from connection where connectionStatus='ACTIVE' and taluk=?1",nativeQuery = true)
